...
public class NativeCrashHandler implements a {
    ...
    private NativeCrashHandler(Context context, com.tencent.bugly.yaq.crashreport.common.info.a aVar, b bVar, w wVar, boolean z, String str) {
        this.b = z.a(context);
        try {
            if (z.a(str)) {
            ...
            str = "/data/data/" + com.tencent.bugly.yaq.crashreport.common.info.a.a(context).c + "/app_bugly";
        }
        this.n = bVar;
        this.f = str;
        this.c = aVar;
        this.d = wVar;
        this.g = z;
        this.e = new a(context, aVar, bVar, com.tencent.bugly.yaq.crashreport.common.strategy.a.a());
    }

    public static synchronized NativeCrashHandler getInstance(Context context, com.tencent.bugly.yaq.crashreport.common.info.a aVar, b bVar, com.tencent.bugly.yaq.crashreport.common.strategy.a aVar2, w wVar, boolean z, String str) {
        ...
        if (this.j) {
            ...
            if (this.i) {
                ...
                try {
                    ...
                    objArr[0] = this.f;
                    objArr[1] = com.tencent.bugly.yaq.crashreport.common.info.b.a(this.b, false);
                    ...
                    if (str3 == null) {
                        ...
                        str3 = (String) z.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler", null, clsArr2, new Object[]{this.f, com.tencent.bugly.yaq.crashreport.common.info.b.a(this.b, false), Integer.valueOf(com.tencent.bugly.yaq.crashreport.common.info.a.K())});
                    }
                    if (str3 != null) {
                        this.j = true;
                        com.tencent.bugly.yaq.crashreport.common.info.a.b().n = str3;
        ...
        if (this.i || this.h) {
            ...
            if (!z) {
                ...
                if (!"yaq".contains("@")) {
                    ...
                    this.c.getClass();
                    str = append.append("yaq").toString();
                }
            } else {
                str = str2;
            }
    ...
    public synchronized void onStrategyChanged(StrategyBean strategyBean) {
        ...
        synchronized (this) {
            ...
            if (!com.tencent.bugly.yaq.crashreport.common.strategy.a.a().c().g || !this.k) {
                z = false;
            }
            if (z != this.j) {
