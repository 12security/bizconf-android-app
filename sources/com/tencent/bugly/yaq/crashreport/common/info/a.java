...
public final class a {
    ...
    public com.tencent.bugly.yaq.crashreport.a D = null;
    ...
    private a(Context context) {
        ...
        try {
            if (!context.getDatabasePath("bugly_db_yaq").exists()) {
                this.z = true;
    ...
    public final String f(String str) {
        ...
        synchronized (this.av) {
            str2 = (String) this.ai.remove(str);
        }
        return str2;
    }
