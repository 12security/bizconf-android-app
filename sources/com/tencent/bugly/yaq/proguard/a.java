...
public class a {
    ...
    public static aq a(UserInfoBean userInfoBean) {
        ...
        aqVar.g = com.tencent.bugly.yaq.crashreport.common.info.a.b().i();
    ...
    public static am a(Context context, int i, byte[] bArr) {
        ...
        try {
            ...
            synchronized (b2) {
                ...
                amVar.k.put("A60", b2.z());
                amVar.k.put("A61", b2.A());
                amVar.k.put("A62", b2.R());
                amVar.k.put("A63", b2.S());
                amVar.k.put("F11", b2.z);
                amVar.k.put("F12", b2.y);
                amVar.k.put("G1", b2.u());
                amVar.k.put("A64", b2.T());
                if (b2.B) {
                    amVar.k.put("G2", b2.L());
                    amVar.k.put("G3", b2.M());
                    amVar.k.put("G4", b2.N());
                    amVar.k.put("G5", b2.O());
                    amVar.k.put("G6", b2.P());
                    amVar.k.put("G7", Long.toString(b2.Q()));
                }
                amVar.k.put("D3", b2.k);
                if (com.tencent.bugly.yaq.b.b != null) {
                    for (com.tencent.bugly.yaq.a aVar : com.tencent.bugly.yaq.b.b) {
