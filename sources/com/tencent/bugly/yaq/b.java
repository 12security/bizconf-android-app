    ...
    public static synchronized void a(Context context, String str, boolean z, BuglyStrategy buglyStrategy) {
        ...
        synchronized (b.class) {
            if (e) {
                ...
                x.a("[init] Bugly version: v%s", "2.8.8");
                x.a("yaq crash report start initializing...", new Object[0]);
                x.b("[init] Bugly start initializing...", new Object[0]);
                x.a("[init] Bugly complete version: v%s", "2.8.8");
                ...
                d = p.a(a2, b);
                u.a(a2);
                com.tencent.bugly.yaq.crashreport.common.strategy.a a4 = com.tencent.bugly.yaq.crashreport.common.strategy.a.a(a2, b);
                n a5 = n.a(a2);
                if (a(a3)) {
                    a = false;
                } else {
                    ...
                    com.tencent.bugly.yaq.crashreport.biz.b.a(a2, buglyStrategy);
                    int i = 0;
                    while (true) {
                        int i2 = i;
                        if (i2 < b.size()) {
